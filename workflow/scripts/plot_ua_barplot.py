...
def plot_barplot(data: pd.DataFrame, xlabel: str | None = None, ylabel: str | None = None) -> tuple[plt.figure, plt.axes]:
...
if __name__ == "__main__":
    ...
    results_filtered = results[results["barplot"] == name]
    ...
    units = results_filtered.unit.values[0] # sanitize checks that all units are the same
